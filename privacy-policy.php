...
<!-- Mirrored from sanatandharmafoundation.com/privacy-policy.php by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 02 Jul 2026 06:34:03 GMT -->
<head>
    <meta charset="UTF-8">
    ...
    <style>
        *{
        ...
        .Interpretation_Definitions li{
            margin:.3rem 0;
            color: #666;
        }
        .Interpretation_Definitions a{
            text-decoration: none;
            color: orangered;
        }
        .Interpretation_Definitions a:hover{
            color: blue;
        }
        b{
            color: #000;
                        ...
                        <button class="language_select" id="lang">
                            <div class="inner_lang">
                              ...
                              <div class="other_lang">
                                <a href="hindi_version/index.php" id="a">हिंदी</a>
...
<section class="privacy_container">
    <div class="inner_privacy">
        ...
        <div class="first_plicy">
            ...
            <ul class="Interpretation_Definitions">
            ...
            <li><b>Trust</b> (referred to as either &quot;the Trust&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to Sanatan Dharma Foundation ®, W6/5, DLF City. Phase 3, Gurugram 122002.</li>
            ...
            <li><b>Country</b> refers to: India, State Haryana</li>
            ...
            <li><b>Usage Data</b> refers to data collected automatically, either generated by the use of the Service or from the Service infrastructure itself (e.g., the duration of a page visit).</li>
            <li><b>Website</b> refers to <a href="www.sanatandharmafoundation.php">www.sanatandharmafoundation.org</a>, accessible from <a href="mailto:info@sanatandharmafoundation.org"> info@sanatandharmafoundation.org</a></li>
        ...
        <div class="first_plicy">
            ...
            <ul class="Interpretation_Definitions">
                ...
                <li><b>For other purposes:</b> We may use Your information for other purposes, such as data analysis, identifying usage trends, determining the effectiveness of our promotional campaigns and to evaluate and improve our Service, products, services, marketing, and your experience.</li></ul>
        ...
        <div class="first_plicy">
            ...
            <p>The Trust will retain Your Personal Data only for as long as is necessary for the purposes set out in this Privacy Policy. We will retain and use Your Personal Data to the extent necessary to comply with our legal obligations (for example, if we are required to retain your data to comply with applicable laws), resolve disputes, and enforce our legal agreements and policies.</p>
            <p>The Trust will also retain Usage Data for internal analysis purposes. Usage  Data is generally retained for a shorter period of time, except when this data is used to strengthen the security or to improve the functionality of Our Service, or We are legally obligated to retain this data for longer time periods.</p>
        </div>
        <div class="first_plicy">
            <h2>Transfer of Your Personal Data</h2>
            <p>Your information, including Personal Data, is processed at the Trust's operating offices and in any other places where the parties involved in the  processing are located. It means that this information may be transferred to — and maintained on — computers located outside of Your state, province, country or other governmental jurisdiction where the data protection laws may differ than those from Your jurisdiction.</p>
        ...
        <div class="first_plicy">
            ...
            <p>If the Trust is involved in a merger, acquisition or asset sale, Your Personal Data may be transferred. We will provide notice before Your Personal Data is transferred and becomes subject to a different Privacy Policy.</p>
            <h3>Law enforcement</h3>
            <p>Under certain circumstances, the Trust may be required to disclose Your Personal Data if required to do so by law or in response to valid requests by public authorities (e.g., a court or a government agency).</p>
            <h3>Other legal requirements</h3>
            <p>The Trust may disclose Your Personal Data in the good faith belief that such action is necessary to:</p>
            <ul class="Interpretation_Definitions">
        ...
        <div class="first_plicy">
            ...
            <ul class="Interpretation_Definitions">
                <li>By email: <a href="mailto:info@sanatandharmafoundation.org">info@sanatandharmafoundation.org</a></li>
            </ul>
        </div>
    </div>
</section>
...
<!-- Mirrored from sanatandharmafoundation.com/privacy-policy.php by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 02 Jul 2026 06:34:04 GMT -->
</html>